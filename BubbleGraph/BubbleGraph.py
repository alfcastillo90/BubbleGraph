...
import pandas as pd
import math
plotly.tools.set_credentials_file(username='alfcastillo90', api_key='cbfP2PQ4p3FSeoREZPrZ')
offline.init_notebook_mode(connected=True)
data = pd.read_csv("C:/Users/Emmanuel Aguilar/source/repos/BubbleGraph/BubbleGraph/gapminderDataFiveYear.csv")
